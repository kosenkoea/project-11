 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".slider-general")) new core(".swiper", {
        ...
        class ScrollWatcher {
            ...
            getScrollWatcherConfig(paramsWatch) {
                let configWatcher = {};
                if (document.querySelector(paramsWatch.root)) configWatcher.root = document.querySelector(paramsWatch.root); else if (paramsWatch.root !== "null") this.scrollWatcherLogging(`Эмм... родительского объекта ${paramsWatch.root} на странице`);
            ...
            scrollWatcherIntersecting(entry, targetElement) {
                ...
                if (entry.isIntersecting) {
                    if (!targetElement.classList.contains("_watcher-view")) {
                        ...
                        if (targetElement.classList.contains("slider-general")) for (let index = 0; index < menu_links.length; index++) {
                            const element = menu_links[index];
                            if (element.innerHTML == "HOME") element.removeAttribute("href");
                        }
                        if (targetElement.classList.contains("we")) for (let index = 0; index < menu_links.length; index++) {
                            const element = menu_links[index];
                            if (element.innerHTML == "ABOUT") element.removeAttribute("href");
                        }
                        if (targetElement.classList.contains("experience")) for (let index = 0; index < menu_links.length; index++) {
                            const element = menu_links[index];
                            if (element.innerHTML == "SERVICES") element.removeAttribute("href");
                        }
                        if (targetElement.classList.contains("recent-work")) for (let index = 0; index < menu_links.length; index++) {
                            const element = menu_links[index];
                            if (element.innerHTML == "RECENT WORK") element.removeAttribute("href");
                        }
                        if (targetElement.classList.contains("blogs")) for (let index = 0; index < menu_links.length; index++) {
                            const element = menu_links[index];
                            if (element.innerHTML == "BLOG") element.removeAttribute("href");
                        }
                        if (targetElement.classList.contains("contact")) for (let index = 0; index < menu_links.length; index++) {
                            const element = menu_links[index];
                            if (element.innerHTML == "CONTACT") element.removeAttribute("href");
                        }
                    }
                    ...
                    if (targetElement.classList.contains("slider-general")) for (let index = 0; index < menu_links.length; index++) {
                        const element = menu_links[index];
                        if (element.innerHTML == "HOME") element.href = "#";
                    }
                    if (targetElement.classList.contains("we")) for (let index = 0; index < menu_links.length; index++) {
                        const element = menu_links[index];
                        if (element.innerHTML == "ABOUT") element.href = "#";
                    }
                    if (targetElement.classList.contains("experience")) for (let index = 0; index < menu_links.length; index++) {
                        const element = menu_links[index];
                        if (element.innerHTML == "SERVICES") element.href = "#";
                    }
                    if (targetElement.classList.contains("recent-work")) for (let index = 0; index < menu_links.length; index++) {
                        const element = menu_links[index];
                        if (element.innerHTML == "RECENT WORK") element.href = "#";
                    }
                    if (targetElement.classList.contains("blogs")) for (let index = 0; index < menu_links.length; index++) {
                        const element = menu_links[index];
                    ...
                    if (targetElement.classList.contains("contact")) for (let index = 0; index < menu_links.length; index++) {
                        const element = menu_links[index];
                        if (element.innerHTML == "CONTACT") element.href = "#";
                    }
                }
            }
